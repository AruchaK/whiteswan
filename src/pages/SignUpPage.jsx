...
const inputClass =
  'w-full border-0 border-b border-espresso-250 bg-transparent py-2 text-sm text-espresso-800 placeholder:text-espresso-600 focus:outline-none focus:border-espresso-600 transition-colors'
...
function Step1({ data, onChange, onNext }) {
  return (
    <>
      <p className="text-[10px] tracking-[0.18em] text-espresso-600 uppercase mb-5">Step 1 of 4</p>
      <h1 className="font-serif text-[2.4rem] leading-tight text-espresso-900 mb-3">
        Begin your vault.
      </h1>
      <p className="text-sm text-espresso-600 leading-relaxed mb-8">Tell us how to reach you.</p>
...
function Step2({ data, onChange, onNext, onBack }) {
  ...
  return (
    <>
      <p className="text-[10px] tracking-[0.18em] text-espresso-600 uppercase mb-5">Step 2 of 4</p>
      <h1 className="font-serif text-[2.4rem] leading-tight text-espresso-900 mb-3">
        A little about you.
      </h1>
      <p className="text-sm text-espresso-600 leading-relaxed mb-8">
...
function Step3({ data, onChange, onNext, onBack }) {
  ...
  return (
    <>
      <p className="text-[10px] tracking-[0.18em] text-espresso-600 uppercase mb-5">Step 3 of 4</p>
      <h1 className="font-serif text-[2.4rem] leading-tight text-espresso-900 mb-3">
        Secure your legacy.
      </h1>
      <p className="text-sm text-espresso-600 leading-relaxed mb-8">Protect your legacy.</p>
      ...
      <div className="space-y-6 mb-8">
        <FormField label="Create Password">
          <input
            ...
            className={inputClass}
          />
          <p className="text-[11px] text-espresso-600 mt-1.5">
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          />
          <span className="text-[11px] text-espresso-600 leading-relaxed">
...
function Step4({ email }) {
  return (
    <>
      <p className="text-[10px] tracking-[0.18em] text-espresso-600 uppercase mb-5">Step 4 of 4</p>
      <h1 className="font-serif text-[2.4rem] leading-tight text-espresso-900 mb-3">
        Welcome to WhiteSwan.
      </h1>
      <p className="text-sm text-espresso-600 leading-relaxed mb-8">Your vault is ready.</p>

      <StepProgress current={4} />

      <div className="border border-espresso-250 p-6 mb-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[12px] text-espresso-600 leading-relaxed">
