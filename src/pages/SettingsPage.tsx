...
type AccountField = keyof Pick<typeof initialForm, 'fullName' | 'email' | 'phone'>
type NotificationKey = keyof typeof initialNotifications
const NOTIFICATION_KEYS = ['email', 'sms', 'push', 'weeklyNudge'] as const satisfies readonly NotificationKey[]
...
export default function SettingsPage() {
  ...
  const handleChange = (field: AccountField) => (e: ChangeEvent<HTMLInputElement>) => {
              ...
              <>
                ...
                <div className="border-t border-espresso-250 divide-y divide-espresso-250">
                  {NOTIFICATION_KEYS.map((key) => {
                    const { label, desc, enabled } = notifications[key]
                    return (
