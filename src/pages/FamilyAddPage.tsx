...
type FamilyForm = typeof initialForm
type FamilyFormField = keyof FamilyForm
type FormErrors = Partial<Record<FamilyFormField, string>>
type AccessLevel = (typeof ACCESS_LEVELS)[number]['key']
...
export default function FamilyAddPage() {
  ...
  const handleChange = (field: FamilyFormField) => (
  ...
  const inputClass = (field: FamilyFormField) =>
