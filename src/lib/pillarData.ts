...
export type BadgeType = 'warning' | 'secure' | 'recency'
...
export interface PillarPlanningData {
  subtitle: string
  ...
  notesTitle: string
  notes: { will: PlanningNote[]; personal: PlanningNote[] }
}
...
} satisfies Record<PillarKey, PillarPlanningData>
