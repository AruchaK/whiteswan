 ...
 * lifecycle the same way. Pair with lib/useResource.ts. See VaultPage for the
 * reference wiring.
 */
...
export function ErrorState({ title = 'Something went wrong', message = 'We couldn’t load this just now.', onRetry }: ErrorStateProps) {
  return (
    <div
      role="alert"
