...
export default function FloatingPreparednessWidget({
  ...
  return (
    <div className="hidden lg:block fixed bottom-6 left-6 z-40 bg-white border border-black/8 rounded-xl px-5 py-4 w-45 shadow-[0_4px_24px_rgba(0,0,0,0.06)] animate-slide-up">
      ...
      <p className="text-[10px] italic text-espresso-400 leading-snug mt-4 border-t border-black/6 pt-3">
        &ldquo;{quote}&rdquo;
      </p>
    </div>
  )
