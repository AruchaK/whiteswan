    ...
    <section className="relative min-h-screen  flex items-center overflow-hidden bg-[#c9b8a2]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-16 pt-24">
        <div className="max-w-[580px]">
          ...
          {/* Eyebrow label */}
          <p className="text-[14px] lg:text-lg tracking-[0.28em] uppercase text-[#5c4530] font-medium mb-5">
            A Life &amp; Legacy Planning Experience
          </p>

          {/* Main headline */}
          <h1
            className="font-serif text-[44px] sm:text-[45px] lg:text-[54px] font-medium leading-[1.13] text-[#1a1208] mb-2"
          >
            For the life you've lived,<br />
            And the love you'll leave behind.
          </h1>

          <p class="mb-9 text-[##1F1611]">
          ...
          <div className="flex font-poppins flex-col sm:flex-row gap-4">
            <a
              href="#begin"
              className="inline-flex items-center justify-center bg-[#1a1208] text-[#f5f0eb] text-[14px] font-normal px-7 py-3.25 rounded-full no-underline hover:bg-[#2e2010] transition-colors whitespace-nowrap"
            >
              Start Your Life Readiness Compass
            </a>
            <a
              href="#services"
              className="inline-flex items-center justify-center border border-none bg-white text-[#1a1208] text-[14px] font-normal px-7 py-3.25 rounded-full no-underline hover:bg-[#1a1208]/5 hover:border-[#1a1208]/60 transition-all whitespace-nowrap"
            >
              Explore services
            </a>
          </div>
