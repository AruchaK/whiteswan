  ...
  return (
    <section className="relative min-h-screen  flex items-center overflow-hidden bg-[#c9b8a2]">
      ...
      <img
        src="/heroimg.png"
        alt=""
        className="absolute inset-0 w-full h-full object-cover object-[center_-60%]"
      />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-16 pt-24">
        <div className="max-w-[580px]">
          ...
          {/* Eyebrow label */}
          <p className="text-[11px] lg:text-lg tracking-[0.28em] uppercase text-[#5c4530] font-normal mb-5">
            A Life &amp; Legacy Planning Experience
          </p>

          {/* Main headline */}
          <h1
            className="font-serif text-[44px] sm:text-[50px] lg:text-[54px] font-normal leading-[1.13] text-[#1a1208] mb-9"
